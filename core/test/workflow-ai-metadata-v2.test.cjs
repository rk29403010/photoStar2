...
const { DatabaseManager } = require('../dist/core/src/db.js');
const { EventBus } = require('../dist/core/src/events/bus.js');
const { Coordinator } = require('../dist/core/src/coordinator/index.js');
const { listWorkflowModules } = require('../dist/core/src/coordinator/workflows.js');
