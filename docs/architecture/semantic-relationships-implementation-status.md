...
- Canonical local merge gate: **GREEN** at `a62f932` — 394 passed, 1 skipped core test and affected UI smoke passed.
- Published PR head: `a62f932`; remote `quality-gate` and benchmark passed. CodeQL is still completing its Rust analysis. The prior published semantic checkpoint `b489870` passed `quality-gate` on 2026-09-14.
