    ...
    return (
        <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                ...
                <button onClick={onClose} style={{ border: 'none', background: 'transparent', color: '#e2e8f0', cursor: 'pointer' }}>✕</button>
            </div>

            <div style={{ fontSize: '0.8rem', color: '#cbd5e1', marginBottom: 12 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <input
                        type="checkbox"
                        checked={Boolean(manualState.forceDocument)}
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <input
                        type="checkbox"
                        checked={Boolean(manualState.forceHero)}
